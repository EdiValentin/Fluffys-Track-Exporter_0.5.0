...
class AC_GenerateMap(Operator):
    ...
    def execute(self, context):
        ...
        original_render_settings = {
            ...
            'image_format': context.scene.render.image_settings.file_format,
        }
        ...
        try:
            ...
            context.scene.render.image_settings.file_format = 'PNG'  # Force PNG format
            ...
            context.scene.render.image_settings.file_format = original_render_settings['image_format']
...
class AC_CreatePreviewCamera(Operator):
    ...
    def execute(self, context):
        ...
        self.report({'INFO'}, "Preview camera created (render set to 800x400 PNG)")
        return {'FINISHED'}
