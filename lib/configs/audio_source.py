    ...
    def to_dict(self) -> dict:
        if self.audio_type == 'SFX':
            return {
                ...
                'VOLUME': round(self.volume, SAVE_PRECISION),
        ...
        return {
            ...
            'WET_LEVEL': round(self.wet_level, SAVE_PRECISION)
        }
...
REVERB_PRESETS = {
    ...
    'MAPPING': ('decay_time', 'early_delay', 'late_delay', 'hf_reference', 'hf_decay_ratio', 'diffusion', 'density', 'low_shelf_frequency', 'low_shelf_gain', 'high_cut', 'early_late_mix', 'wet_level'),
